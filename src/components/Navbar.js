...
const Navbar = () => {
  ...
  return (
    <div className={isLogin===false?'bg-gray-700 p-2':'bg-cyan-500 p-4 sm:flex justify-between'}>
      ...
      {isLogin && <div className="sm:flex left-[55%] ml-10 sm:mx-2 my-4 sm:my-0">
        ...
        <img className='h-10 m-2 ml-44 sm:ml-0 cursor-pointer' src="https://icons.veryicon.com/png/o/internet--web/prejudice/user-128.png" alt="user123" />
        <p className='items-center mt-4 ml-44 sm:ml-0'>user123</p>
      </div> }
    </div>
  )
}
